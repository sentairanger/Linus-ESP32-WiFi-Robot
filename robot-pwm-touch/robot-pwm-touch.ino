      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("$.ajaxSetup({timeout:1000}); $(\'#forward\').on(\'touchstart\', function(){ $.get(\'/forward\'); {Connection: close}; });");
            client.println("$.ajaxSetup({timeout:1000}); $(\'#forward\').on(\'touchend\', function(){ $.get(\'/stop\'); {Connection: close}; });");
            client.println("$.ajaxSetup({timeout:1000});$(\'#backward\').on(\'touchstart\', function(){ $.get(\'/backward\'); {Connection: close}; });");
            client.println("$.ajaxSetup({timeout:1000}); $(\'#backward\').on(\'touchend\', function(){ $.get(\'/stop\'); {Connection: close}; });");
            client.println("$.ajaxSetup({timeout:1000});$(\'#left\').on(\'touchstart\', function(){ $.get(\'/left\'); {Connection: close}; });");
            client.println("$.ajaxSetup({timeout:1000}); $(\'#left\').on(\'touchend\', function(){ $.get(\'/stop\'); {Connection: close}; });");   
            client.println("$.ajaxSetup({timeout:1000});$(\'#right\').on(\'touchstart\', function(){ $.get(\'/right\'); {Connection: close}; });");
            client.println("$.ajaxSetup({timeout:1000}); $(\'#right\').on(\'touchend\', function(){ $.get(\'/stop\'); {Connection: close}; });");
            client.println("$.ajaxSetup({timeout:1000}); $(\'#blink\').on(\'touchstart\', function(){ $.get(\'/on\'); {Connection: close}; });");
            client.println("$.ajaxSetup({timeout:1000}); $(\'#blink\').on(\'touchend\', function(){ $.get(\'/off\'); {Connection: close}; }); </script>");             
